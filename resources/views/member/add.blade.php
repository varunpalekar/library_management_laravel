            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/member/add') }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group{{ $errors->has('publication') ? ' has-error' : '' }}">
                                <label class="col-md-4 control-label">Member Address</label>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-btn fa-sign-in"></i>Add Book
                                    </button>
                                </div>
                            </div>
                        </form>
